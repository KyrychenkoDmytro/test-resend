                ...
                {screenWidth.desktop ?
                    ...
                    (
                        ...
                        >
                            ...
                            <SwiperSlide><div className={`${styles.item4} ${styles.item}`}></div></SwiperSlide>
                            <SwiperSlide><div className={`${styles.item5} ${styles.item}`}></div></SwiperSlide>
                            <SwiperSlide><div className={`${styles.item6} ${styles.item}`}></div></SwiperSlide>
                            <SwiperSlide><div className={`${styles.item7} ${styles.item}`}></div></SwiperSlide>
                            <SwiperSlide><div className={`${styles.item8} ${styles.item}`}></div></SwiperSlide>
                            <SwiperSlide><div className={`${styles.item9} ${styles.item}`}></div></SwiperSlide>
