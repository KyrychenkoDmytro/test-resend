            ...
            <div className={styles.body}>
                ...
                {level != 'рівень 4' ? (
                    <div className={styles.price_container}>
                        ...
                        <Link href="#" className={styles.link}><button className={styles.button}>Купити зі знижкою</button></Link>
                        <div className={styles.expiration_date}>*ціна зі знижкою <span>{expiration_date}</span></div>
                    </div>
                ) : (
                    <>
                        <Link href="#" className={styles.link}><button className={styles.button}>Записатися</button></Link>
