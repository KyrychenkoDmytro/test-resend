        ...
        <div className={styles.root}>
            ...
            <div className={styles.contact}>
                ...
                <ul className={styles.ul}>
                    <li>
                        <span>Пошта</span>
                        <Link href='mailto:example@example.com' target='_blank'>office.voropaeva@gmail.com</Link>
                    </li>
                    <li>
                        <Link href='https://t.me/voropaevagalyna' target='_blank'>Telegram-канал</Link>
                    </li>
                    <li>
